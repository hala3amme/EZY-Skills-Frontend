      ...
      <section className="pt-[120px] md:pt-[160px] lg:pt-[200px] pb-12 md:pb-16 lg:pb-20 px-4 md:px-8 lg:px-[82px]">
        <div className="max-w-[1920px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
          ...
          <div className="bg-white rounded-[30px] md:rounded-[36px] lg:rounded-[43px] shadow-[3px_4px_7px_6px_rgba(0,0,0,0.09)] p-6 md:p-8 lg:p-12 max-w-[558px] mx-auto lg:mx-0 w-full">
            <h1 className="font-poppins font-semibold text-[28px] md:text-[36px] lg:text-[45px] text-center mb-6 md:mb-8">
              <span className="text-[#003f7d]">Create</span>{' '}
              <span className="text-[#ff8b36]">Account</span>
            </h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
              ...
              <div className="flex justify-center pt-2 md:pt-4">
                <button
                  ...
                  className="px-8 md:px-12 py-2.5 md:py-3 bg-[#003f7d] text-white font-poppins font-semibold text-[16px] md:text-[18px] rounded-lg hover:bg-[#002f5d] transition-colors"
                >
              ...
              <p className="text-center font-poppins font-medium text-[11px] md:text-[12px] text-[#b1b1b1]">
                Already Created?{' '}
                <Link to="/login" className="text-[#787878] hover:text-[#f98149]">
                  Login Here
                </Link>
              </p>
            </form>
            ...
            <div className="flex flex-wrap gap-2 md:gap-3 justify-center">
              <button className="flex items-center gap-2 px-4 md:px-6 py-2.5 md:py-3 bg-[#f3f3f3] rounded-lg hover:bg-gray-200 transition-colors">
                <img src="/images/google-icon.svg" alt="Google" className="w-[20px] md:w-[25px] h-[20px] md:h-[25px]" />
                <span className="font-poppins font-medium text-[14px] md:text-[18px] text-[#8a8a8a]">Sign In</span>
              </button>
              <button className="flex items-center gap-2 px-4 md:px-6 py-2.5 md:py-3 bg-[#3575dc] rounded-lg hover:bg-[#2a5fb3] transition-colors">
                <svg className="w-4 h-4 md:w-5 md:h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M18.77 7.46H14.5v-1.9c0-.9.6-1.1 1-1.1h3V.5h-4.33C10.24.5 9.5 3.44 9.5 5.32v2.15h-3v4h3v12h5v-12h3.85l.42-4z" />
                </svg>
                <span className="font-poppins font-medium text-[14px] md:text-[18px] text-white">Sign In</span>
              </button>
              <button className="flex items-center gap-2 px-4 md:px-6 py-2.5 md:py-3 bg-[#404040] rounded-lg hover:bg-[#333] transition-colors">
                <svg className="w-4 h-4 md:w-5 md:h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
